...
{
    //this makes the score visible and is able to drag and drop it in the editor
    ...
    void Start()
    {
        ...
        numericalScore = PlayerPrefs.GetInt("key", 0);
    ...
    public void SaveKey()
    {
        PlayerPrefs.SetInt("key", numericalScore);
